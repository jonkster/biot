...
extern int ssd1306_clearAll(void);
...
int main(void)
{
    ...
    puts("make udp\n");
    kernel_pid_t udpid = thread_create(udp_stack, sizeof(udp_stack), PRIO, THREAD_CREATE_SLEEPING, udp_server,
                  NULL, "udp");
